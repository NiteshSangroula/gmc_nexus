...
const PremiumCard = () => {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 via-slate-900 to-black dark:from-[#151520] dark:via-[#13131c] dark:to-[#0b0b10] p-6 text-white border border-orange-500/30 shadow-xl">
      ...
      <div className="relative flex items-center justify-between border-b border-white/10 pb-3">
        ...
        <span className="rounded-full bg-gradient-to-r from-orange-500 to-amber-500 px-2.5 py-0.5 text-[10px] font-extrabold uppercase text-white shadow-xs">
          Pro
        </span>
      </div>
      ...
      <div className="relative mt-4 flex items-center justify-between gap-4">
        <div>
          ...
          <Link
            to="/premium"
            className="mt-4 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-orange-500/25 transition-all hover:scale-105"
          >

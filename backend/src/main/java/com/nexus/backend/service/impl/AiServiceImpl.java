...
public class AiServiceImpl implements AiService {
    ...
    @Override
    public List<FlashcardResponse> generateFlashCards(String text){
        String cappedText = text.substring(0, Math.min(text.length(), 8000));

        String prompt =  "Genrate a set flashcard with the following details " + "Create a concise clear question and answers covering the key concept of the following text." + "Input Text : \n\n" + cappedText;
        ...
        try {
            ...
            return objectMapper.readValue(rawJsonText, new TypeReference<List<FlashcardResponse>>() {});
    ...
    private List<FlashcardResponse> getFallbackFlashcards(){
        return List.of(
